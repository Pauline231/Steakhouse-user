...
import { LogInUser, clearRealStatus, selectStatus, selectUsers, selecttoken } from '../../features/authSlice'
      ...
      <div className="flex flex-wrap -mx-3 mb-6">
         ...
         <div className="w-full flex items-center justify-between px-3 mb-3 ">
            ...
            <div className="w-1/2 text-right">
               <a onClick={()=>navigate('/forgotpassword')} className="text-yellow-400 hover:cursor-pointer text-sm tracking-tight">Forgot your password?</a>
            </div>
         </div>
         <div className="w-full md:w-full px-3 mb-6">
            <button className="appearance-none block w-full bg-yellow-400 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-rose-800 focus:outline-none focus:bg-white focus:border-gray-500">Sign in</button>
         </div>
         <div className="mx-auto -mb-6 pb-1">
            <span className="text-center text-xs text-rose-800">or sign up with</span>
         </div>
         <div className="flex items-center w-full mt-2">
            <div className="w-full md:w-1/3 px-3 pt-4 mx-2 border-t border-rose-800">
               <button className='appearance-none flex items-center justify-center  w-full bg-gray-100 text-rose-700 shadow border border-rose-800 rounded-lg py-3 px-3 leading-tight hover:bg-gray-200 hover:text-gray-700 focus:outline-none'>
                  <svg className="h-6 w-6 fill-current text-rose-800" viewBox="0 0 512 512">
                     <path d="M455.27,32H56.73A24.74,24.74,0,0,0,32,56.73V455.27A24.74,24.74,0,0,0,56.73,480H256V304H202.45V240H256V189c0-57.86,40.13-89.36,91.82-89.36,24.73,0,51.33,1.86,57.51,2.68v60.43H364.15c-28.12,0-33.48,13.3-33.48,32.9V240h67l-8.75,64H330.67V480h124.6A24.74,24.74,0,0,0,480,455.27V56.73A24.74,24.74,0,0,0,455.27,32Z"/>
                  </svg>
               </button>
            </div>
            <div className="w-full md:w-1/3 px-3 pt-4 mx-2 ">
               <button className="appearance-none flex items-center justify-center w-full bg-gray-100 text-rose-800 shadow border border-rose-800 rounded-lg py-3 px-3 leading-tight hover:bg-gray-200 hover:text-gray-700 focus:outline-none">
                  <svg className="h-6 w-6 fill-current text-rose-800" viewBox="0 0 512 512">
