...
const Hero = () => {
  return (
    ...
    <section className="relative flex flex-col w-screen justify-center  max-container min-h-[70vh] bg-steak bg-cover bg-center max-sm:container gap-10">
      ...
      <h1 className='text-8xl text-yellow-500 font-montserrat max-sm:text-3xl '><b>Sizzling 
        <span className='text-rose-800'> Steak</span> <br></br>Adventure!</b></h1>
      <p className='text-2xl py-5 mt-2 text-amber-700 font-montserrat max-w-lg max-sm:text-sm'>Sink your teeth into succulent perfection! Try our mouthwatering steak today!</p>
